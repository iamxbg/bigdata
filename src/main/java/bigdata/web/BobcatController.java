...
@Controller
@RequestMapping(value="/bobcat")
public class BobcatController {
	
	//@Autowired
	@Resource(name="bobcatServiceImpl")
	private BobcatService bobcatService;
	
	private final String cs="cdbbc";
	private final String cl="dcslog";
	
	@Resource(name="sequoiadbServiceImpl")
