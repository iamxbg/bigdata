...
public class Bobcat_LogConvertor extends LogConvertorAdaptor {
	...
	public Bobcat_LogConvertor(String startTime, String endTime) {
	...
	public BSONObject statistics(){
		...
		StringBuilder sb=new StringBuilder("select ErrMessage,hostname,count(_id) as count from cdbbc.dcslog where log_date >= '")
					.append(getStartTime())
					.append("' and log_date <'")
					.append(getEndTime())
	...
	public void doStatistics(){
		...
		try {
			...
			DBCollection col=sdb2.getCollectionSpace(super.props.getProperty("bigdata.bobcat.cs"))
								 .getCollection(super.props.getProperty("bigdata.bobcat.cl"));
			
			System.out.println(props.get("bigdata.bobcat.cs")+" # "+props.getProperty("bigdata.bobcat.cl"));
